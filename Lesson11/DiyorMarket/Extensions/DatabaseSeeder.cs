...
namespace DiyorMarket.Extensions
{
    public static class DatabaseSeeder
    {
        ...
        public static void CreateSupplier(DiyorMarketDbContext context)
        {
        ...
        public static void CreateSupply(DiyorMarketDbContext context)
        {
        ...
        public static void CreateSupplyItem(DiyorMarketDbContext context)
        {
