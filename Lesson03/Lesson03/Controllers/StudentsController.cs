    ...
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Students != null ? 
                          ...
                          Problem("Entity set 'PdpDbContext.Students'  is null.");
        }

        [HttpPost]
        public IActionResult Index(string searchTerm)
        {
            var results = _context.Students.Where(s => s.FullName.Contains(searchTerm, StringComparison.OrdinalIgnoreCase)).ToList();
            return View(results);
        }
