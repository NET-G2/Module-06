    ...
    public class TeachersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Teachers != null ? 
                          ...
                          Problem("Entity set 'PdpDbContext.Teachers'  is null.");
        }
        ...
        public async Task<IActionResult> Index(string? searchString)
        {
            ...
            var teacherLastName = await _context.Teachers
                .Include(s => s.Assignments)
                .Where(s => s.LastName.ToLower().Contains(searchString.ToLower().ToString()))
                .ToListAsync();

            var teacherPhoneNumber = await _context.Teachers
                .Include(s => s.Assignments)
                .Where(s => s.PhoneNumber.Trim().Contains(searchString.Trim()))
                .ToListAsync();


            teacher.AddRange(teacherLastName);
            teacher.AddRange(teacherPhoneNumber);
